module.exports = {
	entries: {
		...
		philosophy: {
			title: 'Dein auf dich zugeschnittener, gesunder Weg zu funktionaler Kraft, verbessertem Körpergefühl und höherem Bewegungsverständnis.'
		},
		profile: {
			title: {
				headline: 'Effizientes, effektives Training ist vor allem eines: individuell zugeschnitten.',
				summary: 'Ich passe bewährte Trainingsmethoden und neueste Erkenntnisse der Sportmedizin spezifisch auf dich und deine Bedürfnisse an.<br>Dadurch kannst du mess- und spürbare Fortschritte erzielen und gleichzeitig etwas für deine Gesundheit tun.<br>'
			},
			cv: {
		...
		pricing: {
			title: 'Preise',
			conditions: 'Eine Trainingseinheit dauert 60 Minuten. Kürzere oder längere Trainingseinheiten können individuell abgesprochen werden.',
			footer: 'Alle Preise gelten innerhalb von Berlin inkl. Anreise. Bei längerer Anreise werden die Preise gesondert vereinbart.',
			perUnit: '/ Einheit',
			items: {
