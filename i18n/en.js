module.exports = {
  entries: {
    ...
    studio: {
      heading: "Welcome at my new training studio!",
      description:
    ...
    profile: {
      title: {
        ...
        summary:
          "I tailor well proven methods of training and latest knowledge of sports medicine specifically to your needs.<br>Thus you will make measurable and noticeable progress while strengthening your health along the way.",
      },
      cv: {
        headline: "sports cv",
        certificates: {
    ...
    pricing: {
      ...
      footer: "Training exclusively takes place in my training studio:",
      perUnit: "per session",
      items: {
        ...
        testTraining: {
          ...
          subTitle: "Try it out",
          details:
            '<p><small class="text-muted">Trust and sympathy are key factors for successful personal training. A test session (after a brief dialogue about your goals) is the perfect opportunity to get to know each other and see if we\'re a fit.</small></p>' +
        ...
        singleSession: {
          ...
          details:
            '<p><small class="text-muted">The single session provides the possibility to do a few sessions without a big commitment.</small></p>' +
        ...
        upgrade: {
          ...
          details:
            '<p><small class="text-muted">You need a more intense strength training? Adding a longer mobility part sounds good? If you want to address more topics or train more intensely in a specific direction, you can extend an already booked session.</small></p>' +
        ...
        consultation: {
          ...
          details:
            '<p><small class="text-muted">You don\'t mind training on your own and know exactly what you want to achieve, but you lack the idea of how to traing strength and muscle building effectively? Then all you need is a good workout plan.</small></p>' +
    ...
    contact: {
      title: "Contact",
      subTitle:
        "Convinced I can help you with your training?<br>" +
